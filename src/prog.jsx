...
import rendervid from './vid/Comp2.mp4';
import red from './vid/red.mp4';
...
function Prog() {
  ...
  return (
    <div className="prog">
      ...
      <Preloader />
      <div className="left">
        <video src={rendervid} autoPlay loop muted center id="render-left"/>
      </div>
      <div className="right">
      <video src={rendervid} autoPlay loop muted center id="render-right"/>
       </div>
       <div className="content">
        <div className="content-left">
          ...
          <h2 id="txt1">This is my<br></br><span>Portfolio</span></h2>
